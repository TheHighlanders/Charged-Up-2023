...
public class HybridEngage extends SequentialCommandGroup {
  /** Creates a new BalanceAUTON. */
  public HybridEngage(SwerveSubsystem swerveSubsystem, Arm armSubsystem, Intake intakeSubsystem, GrabberSubsystem grabberSubsystem, GyroSubsystem gyroSubsystem) {
