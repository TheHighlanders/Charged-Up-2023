...
public class HybridMobilityEngageAUTO extends SequentialCommandGroup {
  /** Creates a new HybridMobilityEngageAUTO. */
  public HybridMobilityEngageAUTO(SwerveSubsystem swerveSubsystem, Intake intakeSubsystem, GyroSubsystem gyroSubsystem) {
