...
<<<<<<< HEAD:src/main/java/frc/robot/commands/AutonCMDs/AUTONgroups/HighCubeMobilityAUTO.java
...
=======
      ...
      // new DeployIntakeCMD(intakeSubsystem, armSubsystem),
      // new AUTOWaitCMD(1),
>>>>>>> parent of 599bbaa (Post Comp Code):src/main/java/frc/robot/commands/AutonCMDs/AUTONgroups/BalanceAUTON.java
