...
public class HighConeMobility extends SequentialCommandGroup {
  /** Creates a new BackupAUTON. */
  public HighConeMobility(SwerveSubsystem swerveSubsystem, GrabberSubsystem grabberSubsystem, Arm armSubsystem, Intake intakeSubsystem) {
