...
public class HighCubeEngageAUTO extends SequentialCommandGroup {
  /** Creates a new HighCubeEngageAUTO. */
  public HighCubeEngageAUTO(SwerveSubsystem swerveSubsystem, Intake intakeSubsystem, Arm armSubsystem, GrabberSubsystem grabberSubsystem, GyroSubsystem gyroSubsystem) {
